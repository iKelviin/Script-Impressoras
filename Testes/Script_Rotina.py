...
class Primeiro_Turno:
    def Inicio_Primeiro_Turno(self):
        self.MFP_432()
...
class Terceiro_Turno:
    def Inicio_Terceiro_Turno(self):
        self.MFP_432()
        self.Salvar_Dados_MFP_432()
        self.MFP_E52645()
        self.Salvar_Dados_MFP_E52645()
...
def Script_Rotina(self):
    Primeiro_Turno.Inicio_Primeiro_Turno(self)
    Segundo_Turno.Inicio_Segundo_Turno(self)
    Terceiro_Turno.Inicio_Terceiro_Turno(self)

schedule.every().seconds.do(Script_Rotina)
